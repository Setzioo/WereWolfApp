...
class TutoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rules_roles_sorciere.text="• Sorcière •\n" +
        ...
        rules_roles_pipoteur.text="• Pipoteurs •\n" +
        ...
        rules_role_carte.text="Les cartes :"

        rules_role_chasseur.text="• Chasseur  •\n" +
        ...
        rules_role_voyante.text="• Voyante •\n" +
