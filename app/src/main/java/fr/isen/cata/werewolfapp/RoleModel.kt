...
class Ange() : RoleModel(
    7,
    "Ange",
    "Son objectif est d'être éliminé par le village lors du premier vote de jour.\nS'il réussit, il gagne la partie. Sinon, il devient un Simple Villageois."
)

class Pipoteur() : RoleModel(
    8,
    "Pipoteur",
    "Son objectif est d'enchanter tous les joueurs vivants de la partie. Il peut enchanter jusqu'à deux personnes par nuit."
)